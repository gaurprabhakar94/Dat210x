import pandas as pd
import os
os.chdir("C:\Users\PG\Desktop\edx excel\DAT210x\DAT210x-master\Module6\Datasets")
...
#
# .. your code here ..
plt.imshow(X_test.iloc[1000,:].reshape(8,8), cmap=plt.cm.Blues, interpolation = 'nearest')
