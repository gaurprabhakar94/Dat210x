...
#
# .. your code here ..
col = [    'classes','cap-shape','cap-surface','cap-color',
...
X = pd.read_csv("agaricus-lepiota.data", sep=',', names = col , na_values = "?")
print(X.classes)
...
#
# .. your code here ..
col2 = [   'cap-shape','cap-surface','cap-color',
           'bruises','odor','gill-attachment',
           'gill-spacing', 'gill-size','gill-color',
           'stalk-shape','stalk-root','stalk-surface-above-ring',
           'stalk-surface-below-ring','stalk-color-above-ring',
...
X = pd.get_dummies(X, columns = col2)
