...
#
# .. your code here ..
X = pd.read_csv("wheat.data", sep=',', header=0, index_col=0)
print(X)
...
#
# TODO: Create an Decision Tree Classifier named dct
# Set the max_depth to 9, and random_state=2
#
# .. your code here ..

dct = tree.DecisionTreeClassifier(max_depth = 1, random_state = 2)


#
# Add in the benchmark and drawPlots call for all classifiers.
#
